...
def scrape_link(url, ally, driver):
    driver.get(url)
...
counters = scrape_link(f"https://u.gg/lol/champions/{enemy_adc}/matchups", False, driver)
duos = scrape_link(f"https://u.gg/lol/champions/{ally_supp}/duos", True, driver)
driver.quit()
